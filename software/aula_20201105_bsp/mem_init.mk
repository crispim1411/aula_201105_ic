...
# Memory: onchip_memory2_ic
MEM_0 := aula_20201105_qsys_onchip_memory2_ic
$(MEM_0)_NAME := onchip_memory2_ic
...
$(MEM_0)_HIERARCHICAL_PATH := onchip_memory2_ic
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_memory2_ic
onchip_memory2_ic: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
