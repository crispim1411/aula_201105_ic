...
SOPCINFO_FILE := C:/Users/ianin/Downloads/CEFET/Dispositivos_Reprogramaveis/aula_20201105/aula_20201105_qsys.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios2_qsys_ic
CPU_NAME = nios2_qsys_ic
...
# Design Name 
# setting SOPC_NAME is aula_20201105_qsys
SOPC_NAME := aula_20201105_qsys
...
# setting hal.stderr is jtag_uart_ic
ELF_PATCH_FLAG  += --stderr_dev jtag_uart_ic

# Slave descriptor of STDIN character-mode device. This setting is used by the 
# ALT_STDIN family of defines in system.h. none 
# setting hal.stdin is jtag_uart_ic
ELF_PATCH_FLAG  += --stdin_dev jtag_uart_ic
...
# setting hal.stdout is jtag_uart_ic
ELF_PATCH_FLAG  += --stdout_dev jtag_uart_ic
